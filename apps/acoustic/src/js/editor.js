		...
		$(element).wysiwyg({
				...
				videoFromUrl: function( url ) {
						...
						if( youtube_match && youtube_match[1].length == 11 )
								return '<div class="content_embed"><iframe class="embed" src="//www.youtube.com/embed/' + youtube_match[1] + '" width="560" height="315" frameborder="0" allowfullscreen></iframe></div>';

						// vimeo - http://embedresponsively.com/
						var vimeo_match = url.match( /^(?:http(?:s)?:\/\/)?(?:[a-z0-9.]+\.)?vimeo\.com\/([0-9]+)$/ );
						if( vimeo_match )
								return '<div class="content_embed"><iframe class="embed" src="//player.vimeo.com/video/' + vimeo_match[1] + '" width="560" height="315" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div';
